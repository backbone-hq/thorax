...
impl ButtonAction {
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            ButtonAction::NewSecret => "+ Secret",
            ButtonAction::EditSecret => "Edit value",
            ButtonAction::Relabel => "Move secret",
            ButtonAction::DeleteSecret => "Delete secret",
            ButtonAction::RevealSecret => "Reveal",
            ButtonAction::HideSecret => "Hide",
            ButtonAction::InviteUser => "+ Invite",
            ButtonAction::DeleteUser => "Delete user",
            ButtonAction::NewGrant => "+ Grant access",
            ButtonAction::GrantHere => "+ Grant access",
            ButtonAction::DeleteGrant => "Delete grant",
            ButtonAction::NewGroup => "+ Group",
            ButtonAction::AddMember => "+ Member",
            ButtonAction::DeleteAccess => "Delete group",
            ButtonAction::ResolveConflict => "Resolve conflict",
        }
    }
